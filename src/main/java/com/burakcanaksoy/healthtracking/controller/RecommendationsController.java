...
public class RecommendationsController {
    ...
    public ResponseEntity<ApiResponse<Recommendations>> createDailyRecommendation() {
        Recommendations recommendations = recommendationsService.createDailyRecommendation();
        return ResponseEntity.ok(ApiResponse.success("Recommendations successfully created.", recommendations));
    }
