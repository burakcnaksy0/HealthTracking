...
public class WaterIntakeController {
    ...
    @PostMapping("/intake")
    public ResponseEntity<ApiResponse<WaterIntakeResponse>> intakeWater(
    ...
    @org.springframework.web.bind.annotation.GetMapping("/today")
    public ResponseEntity<ApiResponse<Integer>> getTodayTotal() {
        int total = waterIntakeService.getTodayTotalWater();
        return ResponseEntity.ok(ApiResponse.success("Today's water intake retrieved.", total));
    }
